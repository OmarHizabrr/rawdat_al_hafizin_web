...
export function MainLayout() {
  ...
  const adminNavItems = useMemo(
    () => [
      ...
      { to: '/app/admin/user-types', label: 'أنواع المستخدمين والصلاحيات', Icon: Shield },
      { to: '/app/admin/copy', label: 'النصوص الثابتة', Icon: FileText },
      { to: '/app/admin/branding', label: 'هوية الموقع', Icon: Palette },
    ],
    [str],
  )
